...
<li>
                        <a class="active-menu"  href="adminstudent.php"><i class="fa fa-bolt "></i>First Year Details</a>
                    </li>
					<li>
...
<?php  
  $sql = "SELECT Rollno, Name, CGPA FROM 1yr";
...
<form action="adminstudent.php" method="post">
		...
		CGPA: <input type="number" name="cgpa">
...
$mysql="INSERT INTO $table(Rollno, name, CGPA) VALUES ('$rollno', '$user','$cgpa')";
if($con->query($mysql)) {
	echo "data inserted";
}
